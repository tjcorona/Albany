...
FORTRAN_API int FORT_CALL nfmpi_iput_var1_text_ ( int *v1, int *v2, MPI_Offset v3[], char *v4 FORT_MIXED_LEN(d4), MPI_Fint *v5 FORT_END_LEN(d4) ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = NULL;
    ...
    ierr = ncmpi_iput_var1_text( *v1, l2, l3, v4, v5 );
