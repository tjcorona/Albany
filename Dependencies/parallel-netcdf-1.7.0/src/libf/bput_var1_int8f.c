...
FORTRAN_API int FORT_CALL nfmpi_bput_var1_int8_ ( int *v1, int *v2, MPI_Offset v3[], const long long * v4, MPI_Fint *v5 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = NULL;
    ...
    ierr = ncmpi_bput_var1_longlong( *v1, l2, l3, v4, v5 );
