...
FORTRAN_API int FORT_CALL nfmpi_iput_varn_text_ ( int *v1, int *v2, int *v3, MPI_Offset *v4, MPI_Offset *v5, char *v6 FORT_MIXED_LEN(d6), MPI_Fint *v7 FORT_END_LEN(d6) ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = NULL;
    MPI_Offset **l5 = NULL;
    ...
    ierr = ncmpi_iput_varn_text( *v1, l2, *v3, l4, l5, v6, v7 );
