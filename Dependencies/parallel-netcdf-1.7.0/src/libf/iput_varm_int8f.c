...
FORTRAN_API int FORT_CALL nfmpi_iput_varm_int8_ ( int *v1, int *v2, MPI_Offset v3[], MPI_Offset v4[], MPI_Offset v5[], MPI_Offset v6[], const long long * v7, MPI_Fint *v8 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = NULL;
    MPI_Offset *l4 = NULL;
    ...
    ierr = ncmpi_iput_varm_longlong( *v1, l2, l3, l4, l5, l6, v7, v8 );
