...
FORTRAN_API int FORT_CALL nfmpi_get_varm_int8_all_ ( int *v1, int *v2, MPI_Offset v3[], MPI_Offset v4[], MPI_Offset v5[], MPI_Offset v6[], long long * v7 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = NULL;
    MPI_Offset *l4 = NULL;
    ...
    ierr = ncmpi_get_varm_longlong_all( *v1, l2, l3, l4, l5, l6, v7 );
