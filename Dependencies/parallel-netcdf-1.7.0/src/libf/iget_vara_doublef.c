...
FORTRAN_API int FORT_CALL nfmpi_iget_vara_double_ ( int *v1, int *v2, MPI_Offset v3[], MPI_Offset v4[], double *v5, MPI_Fint *v6 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = NULL;
    MPI_Offset *l4 = NULL;
    ...
    ierr = ncmpi_iget_vara_double( *v1, l2, l3, l4, v5, v6 );
