...
FORTRAN_API int FORT_CALL nfmpi_iget_vara_ ( int *v1, int *v2, MPI_Offset v3[], MPI_Offset v4[], void *v5, MPI_Offset *v6, MPI_Fint *v7, MPI_Fint *v8 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = NULL;
    MPI_Offset *l4 = NULL;
    ...
    ierr = ncmpi_iget_vara( *v1, l2, l3, l4, v5, *v6, MPI_Type_f2c(*v7), v8 );
