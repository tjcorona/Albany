...
FORTRAN_API int FORT_CALL nfmpi_bput_varn_ ( int *v1, int *v2, int *v3, MPI_Offset *v4, MPI_Offset *v5, void *v6, MPI_Offset *v7, MPI_Fint *v8, MPI_Fint *v9 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = NULL;
    MPI_Offset **l5 = NULL;
    ...
    ierr = ncmpi_bput_varn( *v1, l2, *v3, l4, l5, v6, *v7, MPI_Type_f2c(*v8), v9 );
