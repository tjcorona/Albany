...
FORTRAN_API int FORT_CALL nfmpi_put_vars_double_ ( int *v1, int *v2, MPI_Offset v3[], MPI_Offset v4[], MPI_Offset v5[], double *v6 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = NULL;
    MPI_Offset *l4 = NULL;
    ...
    ierr = ncmpi_put_vars_double( *v1, l2, l3, l4, l5, v6 );
