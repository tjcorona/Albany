...
FORTRAN_API int FORT_CALL nfmpi_iget_vars_text_ ( int *v1, int *v2, MPI_Offset v3[], MPI_Offset v4[], MPI_Offset v5[], char *v6 FORT_MIXED_LEN(d6), MPI_Fint *v7 FORT_END_LEN(d6) ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = NULL;
    MPI_Offset *l4 = NULL;
    ...
    ierr = ncmpi_iget_vars_text( *v1, l2, l3, l4, l5, v6, v7 );
