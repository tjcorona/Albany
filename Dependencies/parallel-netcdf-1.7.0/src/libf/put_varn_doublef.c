...
FORTRAN_API int FORT_CALL nfmpi_put_varn_double_ ( int *v1, int *v2, int *v3, MPI_Offset *v4, MPI_Offset *v5, double *v6 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = NULL;
    MPI_Offset **l5 = NULL;
    ...
    ierr = ncmpi_put_varn_double( *v1, l2, *v3, l4, l5, v6 );
