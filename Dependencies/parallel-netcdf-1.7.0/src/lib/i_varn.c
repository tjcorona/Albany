              ...
              int                *reqid)
{
    ...
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               bufcount, buftype, reqid, WRITE_REQ,
                               0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_SIGNED_CHAR, reqid, WRITE_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED_CHAR, reqid, WRITE_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED_SHORT, reqid, WRITE_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED, reqid, WRITE_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_DOUBLE, reqid, WRITE_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_LONG_LONG_INT, reqid, WRITE_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED_LONG_LONG, reqid, WRITE_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_SIGNED_CHAR, reqid, READ_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED_CHAR, reqid, READ_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED_SHORT, reqid, READ_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED, reqid, READ_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_LONG_LONG_INT, reqid, READ_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED_LONG_LONG, reqid, READ_REQ, 0);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_SIGNED_CHAR, reqid, WRITE_REQ, 1);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED_CHAR, reqid, WRITE_REQ, 1);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED_SHORT, reqid, WRITE_REQ, 1);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED, reqid, WRITE_REQ, 1);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_DOUBLE, reqid, WRITE_REQ, 1);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_LONG_LONG_INT, reqid, WRITE_REQ, 1);
}
                 ...
                 int               *reqid)
{
    ...
    /* set bufcount to -1 indicating non-flexible API */
    return ncmpii_igetput_varn(ncp, varp, num, starts, counts, (void*)buf,
                               -1, MPI_UNSIGNED_LONG_LONG, reqid, WRITE_REQ, 1);
}
