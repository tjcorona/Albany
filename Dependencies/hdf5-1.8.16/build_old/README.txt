...
HDF5 1.8 that was compiled on;
    Darwin 15.6.0 x86_64, using AppleClang C 7.3.0.7030031.
...
The contents of this directory are:
    ...
    HDF5-1.8.16-Darwin.dmg    - HDF5 Install Package

Installation
===========================================================================
1. Execute HDF5-1.8.16-Darwin.dmg
2. Follow prompts
===========================================================================
...
To test the installation with the examples;
    ...
    The default installation folder is defined as "/Users/tjcorona/Development/Software/Albany/install".
