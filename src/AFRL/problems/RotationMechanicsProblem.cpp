...
getVariableType(Teuchos::ParameterList& param_list,
    ...
    Albany::RotationMechanicsProblem::MECH_VAR_TYPE& variable_type,
    bool& have_variable,
    bool& have_equation)
{
...
std::string
Albany::RotationMechanicsProblem::
variableTypeToString(Albany::RotationMechanicsProblem::MECH_VAR_TYPE variable_type)
{
    ...
    Albany::StateManager& stateMgr)
{
  ...
  *out << "Calling RotationMechanicsProblem::buildEvaluators" << '\n';
  ...
  *out << "Calling RotationMechanicsProblem::constructDirichletEvaluators" << '\n';
  constructDirichletEvaluators(*meshSpecs[0]);

  if (haveSidesets) {
    *out << "Calling RotationMechanicsProblem::constructNeumannEvaluators" << '\n';
    ...
    const Teuchos::RCP<Teuchos::ParameterList>& responseList)
{
  ...
  ConstructEvaluatorsOp<RotationMechanicsProblem> op(*this,
      fm0,
      meshSpecs,
      stateMgr,
      fmchoice,
...
getValidProblemParameters() const
{
  Teuchos::RCP<Teuchos::ParameterList> validPL =
      this->getGenericProblemParams("ValidRotationMechanicsProblemParams");
